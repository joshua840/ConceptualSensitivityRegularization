...
DEFAULTS="--model configs/FeatureCGR.yaml \
--model.target_layer classifier.1 \
--model.g_ckpt_path null \
--model.g_freeze False \
--model.g_model three_layer \
--model.g_num_classes 1 \
--model.g_activation softplus \
--model.g_softplus_beta 10 \
--model.g_criterion bce \
--model.cgr_stage stage1 \
--model.grad_from logit \
