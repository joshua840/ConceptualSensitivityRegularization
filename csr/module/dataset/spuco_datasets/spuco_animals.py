...
from . import TRAIN_SPLIT, BaseSpuCoDataset, SourceData, SpuCoBirds, SpuCoDogs
...
class SpuCoAnimals(BaseSpuCoDataset):
    ...
    def __init__(
        ...
        super().__init__(root=root, split=split, transform=transform, num_classes=4, verbose=verbose)
